...
> **开发说明：** 本项目由作者发起、设计并持续维护，在开发过程中使用 **OpenAI Codex** 协助代码实现、问题排查、自动化测试和开源文档整理。本项目是独立社区项目，不代表 OpenAI、Mojang 或 Microsoft 的官方产品。
...
维护重点包括 Minecraft 1.12.2 存档兼容、旧版建筑工作流、大地图性能和可审查的 Codex/MCP 制图操作。项目的公开 Issue、测试和版本发布记录用于帮助其他维护者复现与改进这些能力。
